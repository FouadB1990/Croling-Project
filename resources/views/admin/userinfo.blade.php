 ...
 Main content -->
        ...
        <!-- <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0">user info Dashboard</h4>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="page-title">
            <div class="row">
                <h4 class="mb-0">User Name: {{$sailorinfo->name}}</h4>
            </div>
            <br/>
            ...
            <div class="row">
                ...
                <div class="col-sm-6"> 
                    <ul class="list-group">
                        <li class="list-group-item active" style="font-size: 1.4em;">User Photo</li>
                        <img style="height: 400px;"  src="{{asset('/images')}}/{{$sailorinfo->image}}" alt="Card image cap">
                    </ul>                       
                </div>
